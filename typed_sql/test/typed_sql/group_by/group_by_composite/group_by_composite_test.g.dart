...
extension TableItemExt on Table<Item> {
  ...
  Insert<Item> insertValuesMapped<T>(
    ...
    required DateTime Function(T row) timestamp,
    required JsonValue Function(T row) json,
    String? Function(T row)? optText,
    double? Function(T row)? optReal,
    int? Function(T row)? optInteger,
    DateTime? Function(T row)? optTimestamp,
    JsonValue? Function(T row)? optJson,
