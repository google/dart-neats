...
part of 'nullable_bool_where_test.dart';
...
extension TableItemExt on Table<Item> {
  ...
  InsertSingle<Item> insert({required Expr<int> id, Expr<bool?>? value}) =>
  ...
  UpsertSingle<Item> upsert({required Expr<int> id, Expr<bool?>? value}) =>
  ...
  /// Returns a [InsertSingle] statement on which `.execute` must be
  /// called for the row to be inserted.
  InsertSingle<Item> insertValue({required int id, bool? value}) =>
  ...
  /// Returns an [UpsertSingle] statement on which `.execute()` must be
  /// called for the row to be inserted or updated.
  UpsertSingle<Item> upsertValue({required int id, bool? value}) =>
