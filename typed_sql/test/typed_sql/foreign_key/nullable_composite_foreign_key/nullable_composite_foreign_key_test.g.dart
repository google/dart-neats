...
part of 'nullable_composite_foreign_key_test.dart';
...
extension InnerJoinAuthorBookExt on InnerJoin<(Expr<Author>,), (Expr<Book>,)> {
  ...
  Query<(Expr<Author>, Expr<Book>)> usingAuthor() => on(
    (a, b) =>
        a.firstName.equalsUnlessNull(b.authorFirstName) &
        a.lastName.equalsUnlessNull(b.authorLastName),
  );
}
...
extension TableBookExt on Table<Book> {
  ...
  Insert<Book> insertValuesMapped<T>(
    ...
    String? Function(T row)? authorFirstName,
    String? Function(T row)? authorLastName,
...
extension InnerJoinBookAuthorExt on InnerJoin<(Expr<Book>,), (Expr<Author>,)> {
  ...
  Query<(Expr<Book>, Expr<Author>)> usingAuthor() => on(
    (a, b) =>
        b.firstName.equalsUnlessNull(a.authorFirstName) &
        b.lastName.equalsUnlessNull(a.authorLastName),
  );
}
