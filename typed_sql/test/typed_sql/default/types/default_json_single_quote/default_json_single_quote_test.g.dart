...
part of 'default_json_single_quote_test.dart';
  ...
  static final _$table = $ForGeneratedCode.tableDefinition(
    ...
    columnInfo: [
      ...
      $ForGeneratedCode.columnDefinition(
        ...
        defaultValue: (
          kind: 'raw',
          value: const JsonValue({'description': 'it\'s working', 'count': 42}),
        ),
        autoIncrement: false,
        overrides: [],
      ),
...
extension TableItemExt on Table<Item> {
  ...
  UpsertSingle<Item> upsert({Expr<int>? id, Expr<JsonValue>? value}) =>
  ...
  /// Returns an [UpsertSingle] statement on which `.execute()` must be
  /// called for the row to be inserted or updated.
  UpsertSingle<Item> upsertValue({int? id, JsonValue? value}) =>
  ...
  Insert<Item> insertValuesMapped<T>(
    ...
    JsonValue Function(T row)? value,
