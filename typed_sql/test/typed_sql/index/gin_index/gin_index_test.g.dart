...
final class _$Product extends Product {
  _$Product._(this.id, this.name, this.metadata, this.tags);
  ...
  @override
  final JsonValue tags;

  static final _$table = $ForGeneratedCode.tableDefinition(
    tableName: 'products',
    columns: <String>['id', 'name', 'metadata', 'tags'],
    columnInfo: [
  ...
  static Product? _$fromDatabase(RowReader row) {
    ...
    final tags = row.readJsonValue();
    if (id == null && name == null && metadata == null && tags == null) {
      return null;
    }
    return _$Product._(id!, name!, metadata!, tags!);
  }

  @override
  String toString() =>
      'Product(id: "$id", name: "$name", metadata: "$metadata", tags: "$tags")';
}
...
extension TableProductExt on Table<Product> {
  ...
  InsertSingle<Product> insert({
    ...
    required Expr<JsonValue> tags,
  }) => $ForGeneratedCode.insertInto(
    table: this,
    values: [id, name, metadata, tags],
  );
  ...
  InsertSingle<Product> insertValue({
    ...
    required JsonValue tags,
  }) => $ForGeneratedCode.insertInto(
    table: this,
    values: [id?.asExpr, name.asExpr, metadata.asExpr, tags.asExpr],
  );
  ...
  Insert<Product> insertValuesMapped<T>(
    ...
    required JsonValue Function(T row) tags,
  }) => $ForGeneratedCode.insertValuesMapped(
    table: this,
    rows: rows,
    mappings: [id, name, metadata, tags],
  );
  ...
  Update<Product> update(
    ...
    (product) => updateBuilder(
      ...
      ({
        ...
        Expr<JsonValue>? metadata,
        Expr<JsonValue>? tags,
      }) => $ForGeneratedCode.buildUpdate<Product>([id, name, metadata, tags]),
    ),
  );
...
extension InsertProductExt on Insert<Product> {
  ...
  /// * `.update((product, excluded, set) => set(...))` to
...
extension InsertOnConflictProductExt on InsertOnConflict<Product> {
  ...
  ///   * `product` an [Expr] representing the existing row in
  ///     the database,
...
extension ProductChecks on Subject<Product> {
  ...
  /// Create assertions on [Product.tags].
  Subject<JsonValue> get tags => has((m) => m.tags, 'tags');
}
