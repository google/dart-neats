...
part of 'gist_index_test.dart';

// **************************************************************************
// Generator: _TypedSqlBuilder
// **************************************************************************

/// Extension methods for a [Database] operating on [ContactDirectory].
extension ContactDirectorySchema on Database<ContactDirectory> {
  static final _$tables = [_$Contact._$table];

  Table<Contact> get contacts =>
      $ForGeneratedCode.declareTable(this, _$Contact._$table);

  /// Create tables defined in [ContactDirectory].
  ///
  /// Calling this on an empty database will create the tables
  /// defined in [ContactDirectory]. In production it's often better to
  /// use [createContactDirectoryTables] and manage migrations using
  /// external tools.
  ///
...
/// Get SQL [DDL statements][1] for tables defined in [ContactDirectory].
///
/// This returns a SQL script with multiple DDL statements separated by `;`
/// using the specified [dialect].
///
/// Executing these statements in an empty database will create the tables
/// defined in [ContactDirectory]. In practice, this method is often used for
/// printing the DDL statements, such that migrations can be managed by
/// external tools.
///
/// [1]: https://en.wikipedia.org/wiki/Data_definition_language
String createContactDirectoryTables(SqlDialect dialect) =>
    $ForGeneratedCode.createTableSchema(
      dialect: dialect,
      tables: ContactDirectorySchema._$tables,
    );

final class _$Contact extends Contact {
  _$Contact._(this.id, this.email);
  ...
  static Contact? _$fromDatabase(RowReader row) {
    ...
    return _$Contact._(id!, email!);
  }

  @override
  String toString() => 'Contact(id: "$id", email: "$email")';
}
...
extension TableContactExt on Table<Contact> {
  ...
  InsertSingle<Contact> insert({Expr<int>? id, required Expr<String> email}) =>
  ...
  /// Returns a [InsertSingle] statement on which `.execute` must be
  /// called for the row to be inserted.
  InsertSingle<Contact> insertValue({int? id, required String email}) =>
...
extension QueryContactExt on Query<(Expr<Contact>,)> {
  ...
  Update<Contact> update(
    UpdateSet<Contact> Function(
      ...
      UpdateSet<Contact> Function({Expr<int> id, Expr<String> email}) set,
    )
    updateBuilder,
    ...
    (contact) => updateBuilder(
      ...
      ({Expr<int>? id, Expr<String>? email}) =>
          $ForGeneratedCode.buildUpdate<Contact>([id, email]),
    ),
  );
