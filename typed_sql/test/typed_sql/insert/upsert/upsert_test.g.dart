...
extension TableSimpleItemExt on Table<SimpleItem> {
  ...
  UpsertSingle<SimpleItem> upsertValue({
    int? id,
    required String name,
    required int value,
...
extension TableCompositeItemExt on Table<CompositeItem> {
  ...
  /// Returns an [UpsertSingle] statement on which `.execute()` must be
  /// called for the row to be inserted or updated.
  UpsertSingle<CompositeItem> upsertValue({
    required String partA,
    required int partB,
    required String firstName,
    required String lastName,
...
extension TableNullableUniqueItemExt on Table<NullableUniqueItem> {
  ...
  /// Returns an [UpsertSingle] statement on which `.execute()` must be
  /// called for the row to be inserted or updated.
  UpsertSingle<NullableUniqueItem> upsertValue({
    int? id,
    String? code,
    required String description,
  }) => insertValue(id: id, code: code, description: description)
      .onConflict(.primaryKey)
      .update(
        (_, excluded, set) =>
...
extension TableComplexItemExt on Table<ComplexItem> {
  ...
  /// Returns an [UpsertSingle] statement on which `.execute()` must be
  /// called for the row to be inserted or updated.
  UpsertSingle<ComplexItem> upsertValue({
    required int id,
    DateTime? createdAt,
    required String name,
    double? doubleValue,
