...
final _cases = [
  (name: 'true', expr: toExpr(true), expected: true),
  (name: 'false', expr: toExpr(false), expected: false),
  (
  ...
  (name: 'false & false', expr: toExpr(false) & toExpr(false), expected: false),
  (name: 'true & false', expr: toExpr(true) & toExpr(false), expected: false),
  (name: 'false & true', expr: toExpr(false) & toExpr(true), expected: false),
  (name: 'true & true', expr: toExpr(true) & toExpr(true), expected: true),
  (
    name: 'false.or(false)',
  ...
  (name: 'true.or(true)', expr: toExpr(true).or(toExpr(true)), expected: true),
  (name: 'false | false', expr: toExpr(false) | toExpr(false), expected: false),
  (name: 'true | false', expr: toExpr(true) | toExpr(false), expected: true),
  (name: 'false | true', expr: toExpr(false) | toExpr(true), expected: true),
  (name: 'true | true', expr: toExpr(true) | toExpr(true), expected: true),
  (name: 'true.not()', expr: toExpr(true).not(), expected: false),
  (name: 'false.not()', expr: toExpr(false).not(), expected: true),
  (name: '~true', expr: ~toExpr(true), expected: false),
  (name: '~false', expr: ~toExpr(false), expected: true),
  (name: 'true.asInt()', expr: toExpr(true).asInt(), expected: 1),
  (name: 'false.asInt()', expr: toExpr(false).asInt(), expected: 0),
  // Test for .equals
  (
