...
void main() {
  ...
  r.addTest('bool.asExprLiteral', (db) async {
    final value = true;
  ...
  r.addTest('int.asExprLiteral', (db) async {
    final value = 42;
    final result = await db.select(
      (value.asExprLiteral,),
    ).fetch();
  ...
  r.addTest('double.asExprLiteral', (db) async {
    final value = 3.14;
    final result = await db.select(
      (value.asExprLiteral,),
    ).fetch();
  ...
  r.addTest('String.asExprLiteral', (db) async {
  ...
  r.addTest('DateTime.asExprLiteral', (db) async {
  ...
  r.addTest(
    'DateTime.asExprLiteral (with microseconds)',
    (db) async {
  ...
  r.addTest('Uint8List.asExprLiteral', (db) async {
  ...
  r.addTest('JsonValue.asExprLiteral', (db) async {
