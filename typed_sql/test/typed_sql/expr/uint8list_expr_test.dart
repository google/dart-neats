...
final _cases =
    ...
    >[
      ...
      (
        name: '[1,2].operator+([])',
        expr:
            toExpr(Uint8List.fromList([1, 2])) + toExpr(Uint8List.fromList([])),
        expected: Uint8List.fromList([1, 2]),
      ),
      (
        name: '[].operator+([3,4])',
        expr:
            toExpr(Uint8List.fromList([])) + toExpr(Uint8List.fromList([3, 4])),
        expected: Uint8List.fromList([3, 4]),
      ),
...
final _casesToSkipMysql =
    ...
    >[
      ...
      (
        ...
        expr:
            toExpr(Uint8List.fromList([0xC3])) +
            toExpr(Uint8List.fromList([0x28])),
